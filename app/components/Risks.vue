    ...
    <div v-else>
        <div class="frame">
            ...
            <div class="inside-frame">
                <div class="frame second-frame" v-for="item in recommendations" :key="item.id">
                    ...
                    <div class="btn-block">
                        <button v-if="!item.done" class="done-btn header-sm"
                            @click="changeDoneState(item)">Выполнено</button>
                        <button v-else :style="{ 'background-image': checkImg }" class="done-btn-pushed"
                            @click="changeDoneState(item)">
                            <img src="../assets/icons/check.svg" alt="Check image" class="check-img">
                        </button>
                    </div>
                </div>
            </div>
