  ...
  <div class="frame second-frame-setting">
    ...
    <div class="content" :class="contentStyle">
      ...
      <ui-help
        ...
        text="Сотрудники с красным маркером не авторизованы в ВК-боте, направьте им ссылку и попросите получить доступ по ключу из личного кабинета."
        link="https://vk.com/club237041357\z"
        link-text="Ссылка на чат-бот"
      />
    </div>
  </div>
</template>
